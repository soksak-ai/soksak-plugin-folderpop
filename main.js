...
async function getActive(app) {
  const a = await app.data?.kv.get(KEY_ACTIVE);
  return typeof a === "string" ? a : "";
}
async function saveFolders(app, folders) {
  await app.data?.kv.set(KEY_FOLDERS, folders);
}
async function saveActive(app, path) {
  await app.data?.kv.set(KEY_ACTIVE, path);
}
async function addFolder(app, rawPath, name) {
  ...
  const folder = { path, name: (name ?? "").trim() || baseName(path) };
  const next = [...folders, folder];
  await saveFolders(app, next);
  if (folders.length === 0) await saveActive(app, path);
  return folder;
}
async function removeFolder(app, path) {
...
async function renameFolder(app, path, name) {
  const p = normalizePath(path);
  const folders = await listFolders(app);
  let updated = null;
...
async function selectFolder(app, path) {
  const p = normalizePath(path);
  const folders = await listFolders(app);
...
async function activeFolder(app) {
  const folders = await listFolders(app);
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "fp-ic", children: "\u{1F4C1}" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "fp-nm", children: name })
        ]
      }
    ),
...
function SubfolderPicker({
  ...
  const [dirs, setDirs] = (0, import_react.useState)(null);
  (0, import_react.useEffect)(() => {
    if (!root) {
      setDirs([]);
      return;
  ...
  if (!root) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-modal-empty", children: "\uD504\uB85C\uC81D\uD2B8 \uD3F4\uB354\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4." });
  if (dirs === null) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-modal-empty", children: "\u2026" });
  if (dirs.length === 0)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-modal-empty", children: "\uD558\uC704 \uD3F4\uB354\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4." });
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-modal-list", children: dirs.map((d) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "fp-ic", children: "\u{1F4C1}" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "fp-nm", children: d.name }),
          already && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "fp-modal-tag", children: "\uB4F1\uB85D\uB428" })
        ]
      },
      d.name
    );
...
function FoldersView({
  ...
  const onRename = async (path, name) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-root", children: [
    ...
    adding && // 작은 모달 — 프로젝트 폴더의 *하위 폴더*를 골라 등록한다. 배경 클릭/Esc 로 닫힘.
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-modal-head", children: "\uD504\uB85C\uC81D\uD2B8 \uD558\uC704 \uD3F4\uB354 \uC120\uD0DD" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                SubfolderPicker,
                {
                  app,
...
function registerCommands(ctx) {
  ...
  push("folder.add", {
    ...
    handler: async (p) => {
      try {
        const folder = await addFolder(app, p.path, p.name);
  ...
  push("folder.rename", {
    ...
    returns: "{ ok, folder }",
    handler: async (p) => {
      const folder = await renameFolder(app, p.path, p.name);
  ...
  push("folder.select", {
    ...
    returns: "{ ok }",
    handler: async (p) => {
      const ok = await selectFolder(app, p.path);
...
var STYLE_ID = "sk-folderpop-style";
      ...
      ctx.subscriptions.push(
        app.ui.registerView("folders", {
          mount(container, vctx) {
            mountInto(container, /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(FoldersView, { app, ctx: vctx }));
          },
          unmount(container) {
            unmountContainer(container);
          }
